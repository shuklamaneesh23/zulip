...
class MarkdownStreamTopicMentionTests(ZulipTestCase):
    ...
    def test_topic_single_containing_message(self) -> None:
        ...
        self.assertEqual(
            render_message_markdown(msg, content).rendered_content,
            f'<p><a class="stream-topic" data-stream-id="{denmark.id}" href="/#narrow/channel/{denmark.id}-Denmark/topic/some.20topic/with/{last_msg_id}">#{denmark.name} &gt; some topic</a></p>',
        )
    ...
    def test_topic_atomic_string(self) -> None:
        ...
        self.assertEqual(
            render_message_markdown(msg, content).rendered_content,
            f'<p><a class="stream-topic" data-stream-id="{denmark.id}" href="/#narrow/channel/{denmark.id}-Denmark/topic/.231234/with/{last_msg_id}">#{denmark.name} &gt; #1234</a></p>',
        )
    ...
    def test_topic_multiple(self) -> None:
        ...
        self.assertEqual(
            ...
            f'href="/#narrow/channel/{denmark.id}-{denmark.name}/topic/some.20topic/with/{last_msg_id}">'
